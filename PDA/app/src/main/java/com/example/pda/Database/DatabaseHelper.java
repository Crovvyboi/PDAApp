...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void populateTables(SQLiteDatabase sqLiteDatabase){
        ...
        sqLiteDatabase.execSQL("INSERT INTO " + DatabaseContract.Bestelling.TABLE_NAME + "( " +
                ...
                " )" +
                "VALUES ( '8969698924666', '1', 'karen1476@24mail.top', '4-4-2024' ), " +
                "( '1316460054927', '2', 'karen1476@24mail.top', '1-4-2024' ), " +
                "( '8944794311909', '1', 'mjets@otpku.com', '3-4-2024' )");
        ...
        sqLiteDatabase.execSQL("INSERT INTO " + DatabaseContract.Perceel.TABLE_NAME + "( " +
                ...
                DatabaseContract.Perceel.COLUMN_NAME_ADRESID +
                " )" +
                "VALUES ( '2-4-2024', '1316460054927', '1', '1' )");
    }
